<?php
class Set_product extends MY_Controller{
    ...
    function index(){
        $total_rows =  $this->set_model->get_total();
        $this->data['total_rows'] = $total_rows;
        // load ra thu vien phan trang
        $this->load->library('pagination');
        $config = array();
        $config['total_rows'] = $total_rows;// tong so dong
        $config['base_url'] = admin_url('set_product/index'); // link hien thi du lieu
        ...
        // load view
        $this->data['temp'] = 'admin/set_product/index';
    ...
    function add(){
        ...
        // load view
        $this->data['temp'] = 'admin/set_product/add';
        $this->load->view('admin/main', $this->data);
    }
    // chinh sua san pham
    function edit(){
