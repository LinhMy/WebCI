                    ...
                    <?php foreach ($product_set as $row): ?>
                        <li class="product-item style9" style="float: left; width: 28%;">
                            <div class="product-inner">
                                ...
                                <div class="info col-sm-7">
                                    <h3 class="product-name short"><a title="" href="<?php echo base_url('chi-tiet-san-pham/'.seoname($row->name).'/'.seoname($row->name).'/'.$row->product_set_id) ?>"><?php echo $row->name; ?></a></h3>
                                    <div title="Rated 3 out of 5" class="rating">
                                        <i class="active fa fa-star"></i>
                                        <i class="active fa fa-star"></i>
                                        <i class="active fa fa-star"></i>
