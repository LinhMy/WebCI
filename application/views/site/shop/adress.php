...
<div class="tab-catalog" style="width: 1300px; margin: 0px auto; height: auto;">
    <div class="container">      
        ...
        <div class="contact" style="margin-left:300">
          <form action="" method="POST">
            ...
            <textarea id="subject" name="subject" placeholder="Write something.." style="height:200px" rows="5"></textarea>
