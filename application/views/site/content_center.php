...
<div class="kt-category-tabs kt-tab-fadeeffect margin-top-50 " >
    <div class="tab-head">
        ...
        <ul class="nav-tab">
            ...
            <li><a data-animated="fadeInUp" data-toggle="tab" href="#tab-<?php echo $i+1; ?>">Giảm Giá</a></li>
                        ...
                        <?php foreach ($row->subs as $subs){ ?>
                            ...
                            <li class="product-item style10">
                                <div class="product-inner">
                                    <div class="thumb">
                                        <a href="<?php echo base_url('product/view/'.$product->product_id); ?>">
                                            <img style="height: 297px; width: 243px;" src="<?php echo base_url('upload'); ?>/products/<?php echo $product->image_link; ?>" alt="">
                                        </a>
                                        <a href="<?php echo base_url('product/view/'.$product->product_id); ?>" title="Quick View" class="button quick-view yith-wcqv-button">Chi Tiết</a>
                                        <div class="group-button">
                                            <a class="wishlist " href="#">Wishlist</a>
                                            <a class="compare button" href="<?php echo base_url('product/view/'.$product->product_id); ?>">Compare</a>
                                            <a class="button add_to_cart_button" href="<?php echo base_url('cart/add/'.$product->product_id); ?>">Add to cart</a>
                                        </div>

                                    </div>
                                    <div class="info">
                                        <h3 class="product-name short"><a href="<?php echo base_url('product/view/'.$product->product_id); ?>"><?php echo $product->name; ?></a></h3>
