<html>
    ...
    <body class="">
        ...
        <script type="text/javascript" src="<?php echo public_url('site') ?>/js/chosen.jquery.min.js"></script> <!--js slider-->
        ...
        <script type="text/javascript" src="<?php echo public_url('site') ?>/js/wow.min.js"></script> <!-- js luot danh muc-->
        <script type="text/javascript" src="<?php echo public_url('site') ?>/js/jquery.bxslider.min.js"></script> <!--js chuyển ảnh slide-->
        ...
        <script type="text/javascript" src="<?php echo public_url('site') ?>/js/functions.js"></script><!--js function script-->
    </body>
