    ...
    <div class="widgets">
        ...
        <!--div class="widget">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
                ...
                <tr>
                    <td><input type="checkbox" value="20" name="id[]"></td>
                ...
                <tr>
                    <td><input type="checkbox" value="19" name="id[]"></td>
                ...
                <tr>
                    <td><input type="checkbox" value="18" name="id[]"></td>
                ...
                <tr>
                    <td><input type="checkbox" value="17" name="id[]"></td>
                ...
                <tr>
                    <td><input type="checkbox" value="16" name="id[]"></td>
                ...
                <tr>
                    <td><input type="checkbox" value="15" name="id[]"></td>
                ...
                <tr>
                    <td><input type="checkbox" value="14" name="id[]"></td>
                ...
                <tr>
                    <td><input type="checkbox" value="13" name="id[]"></td>
                ...
                <tr>
                    <td><input type="checkbox" value="12" name="id[]"></td>
