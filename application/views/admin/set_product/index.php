<?php
// load ra file head
$this->load->view('admin/set_product/head', $this->data);
?>
<div class="line"></div>
<div class="wrapper">
    ...
    <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
                    ...
                    <form method="get" action="" class="list_filter form">
                        <table width="80%" cellspacing="0" cellpadding="0"><tbody>
                            ...
                            <tr>
                                ...
                                <td style="width:155px;" class="item"><input type="text" style="width:155px;" id="filter_iname" value="<?php echo $this->input->get('set_name'); ?>" name="product_name"></td>
                                
                                <td style="width:150px">
                                    <input type="submit" value="Lọc" class="button blueB">
                                    <input type="reset" onclick="window.location.href = '<?php echo admin_url('Set_model'); ?>'; " value="Reset" class="basic">
                                </td>
            ...
            <tr>
                ...
                <td style="width: 100px;">Tên set sản phẩm</td>
            ...
            <tr>
                <td colspan="8">
                    <div class="list_action itemActions">
                        <a href="#submit" id="submit" class="button blueB" url="<?php echo admin_url('set_product/delete_all'); ?>">
            ...
            <?php foreach ($list as $row): ?>
                <tr class="row_<?php echo $row->set_id; ?>">
                    ...
                    <td class="option">
                        <a href="<?php echo admin_url('product/edit/'.$row->set_id); ?>" title="Chỉnh sửa" class="tipS ">
                            <img src="<?php echo public_url(); ?>/admin/images/icons/color/edit.png" />
                        </a>

                        <a href="<?php echo admin_url('product/delete/'.$row->set_id); ?>" title="Xóa" class="tipS verify_action" >
